...
def test_change_dt():
    orig_date = dt.make_dt('2022-05-17T11:22:00+02:00')
    # All OK
    plus_nineteen_years = dt.make_dt('2041-05-17T11:22:00+02:00')
    minus_four_months = dt.make_dt('2022-01-17T11:22:00+02:00')
    plus_two_days = dt.make_dt('2022-05-19T11:22:00+02:00')
    minus_three_hours = dt.make_dt('2022-05-17T08:22:00+02:00')
    plus_thirty_minutes = dt.make_dt('2022-05-17T11:52:00+02:00')
    plus_two_and_half_hours = dt.make_dt('2022-05-17T13:52:00+02:00')
    ...
    assert dt.change_dt(orig_date, 'add', 2.5, 'hours') == plus_two_and_half_hours
    #Fails
    assert dt.change_dt(orig_date, 'add', 'two', 'days') == None
